...
// Variants for the newsletter section
...
// Variants for text elements inside the newsletter section
...
// Variants for the form elements (input and button)
const formVariants = {
...
// Variants for the footer navigation and social icons
...
// Variants for the copyright and legal section
  ...
  return (
    <footer className="relative bg-gradient-to-l from-[#0F0B0C] to-[#1d0600] text-gray-300 py-10 lg:py-16 px-4 sm:px-6 lg:px-8 overflow-hidden" id="contact">
      <div className="max-w-[1440px] lg:px-10 mx-auto">
        {/* Newsletter Section */}
        <motion.div
          className="relative text-center lg:py-16 px-4 mb-16"
        ...
        <motion.div
          className="flex flex-col gap-4 md:flex-row justify-between items-center border-t border-gray-700 pt-8"
        ...
        >
          <motion.span
            className="text-2xl font-bold text-white md:mb-0"
            variants={textItemVariants}
          >
            Eventive
          </motion.span>
          ...
          <div className="flex space-x-4">
            {/* Social Icons - Animated individually */}
            <motion.a
              href="#"
        ...
        <motion.div
          className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 mt-8"
