  ...
  return (
    <section className=" bg-[#E7E2C9] py-16">
      <div className="max-w-[1440px] mx-auto lg:px-10  px-4 flex flex-col items-center md:flex-row md:justify-between">
        ...
        <button className="bg-[#7A38FC] text-white font-semibold py-4 px-8 rounded-lg shadow-lg  hover:bg-[#5900ff] hover:scale-105   hover:transition-all duration-500 cursor-pointer  ">
          View All Speakers
        </button>
      </div>
    </section>
